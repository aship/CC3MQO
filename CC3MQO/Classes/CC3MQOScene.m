 ...
 *  CC3MQO
 *
 *  Created by aship on 12/11/25.
 *  Copyright __MyCompanyName__ 2012年. All rights reserved.
 */

#import "CC3MQOScene.h"
...
//	[self addContentFromPODFile: @"hello-world.pod"];
    [self addContentFromMQOFile:@"chabudai.mqo" withName:@"Hello"];
	
    CC3MeshNode* cc3MeshNode = (CC3MeshNode*)[self getNodeNamed:@"Hello"];
    cc3MeshNode.uniformScale = 0.005;
